...
InnoDB 逻辑存储结构：
![InnoDB逻辑存储结构](images/逻辑存储结构_20220316030616590001.png "InnoDB逻辑存储结构")
...
![二叉树](images/二叉树_20220316153214227108.png "二叉树")

二叉树的缺点可以用红黑树来解决：
![红黑树](images/红黑树_20220316163142686602.png "红黑树")
红黑树也存在大数据量情况下，层级较深，检索速度慢的问题。

为了解决上述问题，可以使用 B-Tree 结构。
B-Tree (多路平衡查找树) 以一棵最大度数（max-degree，指一个节点的子节点个数）为5（5阶）的 b-tree 为例（每个节点最多存储4个key，5个指针）

![B-Tree结构](images/B-Tree结构_20220316163813441163.png "B-Tree结构")
...
![B+Tree结构图](images/B+Tree结构图_20220316170700591277.png "B+Tree结构图")
...
![MySQL B+Tree 结构图](images/结构图_20220316171730865611.png "MySQL B+Tree 结构图")
...
![Hash索引原理图](images/Hash索引原理图_20220317143226150679.png "Hash索引原理图")
...
![大致原理](images/原理图_20220318194454880073.png "大致原理")
![演示图](images/演示图_20220319215403721066.png "演示图")
